...
def test_add_vectors2():
    ...
    assert LA.add_vectors(test_vector_01, test_vector_02) == [3,2,5]
...
def test_scalar_vector_mult2():
    ...
    assert LA.scalar_vector_mult(test_const_01, test_vector_01) == [1,3,7]
...
def test_scalar_matrix_mult2():
    ...
    assert LA.scalar_matrix_mult(test_const_01, test_matrix_01) == [[1,2,3],[4,5,6],[7,8,9]]
...
def test_add_matrix2():
    assert LA.add_matrix(test_matrix_01,test_matrix_01) == [[1,2,3],[4,5,6],[7,8,9]]
...
def test_matrix_vector_mult2():
    assert LA.matrix_vector_mult(test_matrix_01,test_vector_01) == [1, 2, 3]
...
def test_matrix_matrix_mult2():
    assert LA.matrix_matrix_mult(test_matrix_01, test_matrix_01) == [[1,2,3],[4,5,6],[7,8,9]]
